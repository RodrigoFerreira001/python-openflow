...
from pyof.v0x02.asynchronous.port_status import PortReason, PortStatus
from pyof.v0x02.common.phy_port import (PhyPort, PortConfig, PortFeatures,
                                        PortState)
from pyof.v0x02.foundation.base import OFP_MAX_PORT_NAME_LEN
